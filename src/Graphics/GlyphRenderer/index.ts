...
import { GlyphShader } from './Shader'
import { Tga } from '../../Parsers/Tga'

export class GlyphRenderer {
  static init(context: Context): GlyphRenderer | null {
    const shader = GlyphShader.init(context)
    if (!shader) {
      console.error('Failed to init GlyphRenderer')
      return null
    }

    return new GlyphRenderer({ context, shader })
  }
  ...
  private constructor(params: { context: Context; shader: GlyphShader }) {
